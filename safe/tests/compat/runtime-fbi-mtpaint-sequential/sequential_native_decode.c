...
/*
 * Runtime-dependent sequential decode reproducer for the valid native-viewer
 * path. Framebuffer/UI consumers such as fbi and mtpaint walk records via the
 * low-level DGifGet* APIs and should keep GIF handling on their native path
 * for valid images instead of falling back to convert.
 */
